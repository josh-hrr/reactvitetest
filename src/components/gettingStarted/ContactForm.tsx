  ...
  return ( 
    <div className="ContactForm m-5">  
      ...
      <Form onSubmit={((e) => console.log(e))}>
        ...
        <Form.Group className="mb-3" controlId="exampleForm.ControlSelect1">
          <Form.Label className="text-black">Modalidad</Form.Label>
        ...
        <Form.Group className="mb-3" controlId="exampleForm.ControlSelect1">
          <Form.Label className="text-black">Nivel</Form.Label>
        ...
        <Form.Group className="mb-3" controlId="exampleForm.ControlSelect1">
          <Form.Label className="text-black">Horario</Form.Label>
        ...
        <Form.Group className="mb-3 text-black" controlId="exampleForm.ControlInput1">
